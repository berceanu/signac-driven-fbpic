...
observed for these parameters, and a higher density is used for
stronger self-focusing.

Usage
-----
- Type "python cetal.py" in a terminal
...
zmax = -4.e-6   # Right end of the simulation box (meters)
zmin = -100.e-6   # Left end of the simulation box (meters)
Nr = 512         # Number of gridpoints along r
rmax = 120.e-6  # Length of the box along r (meters)
Nm = 2           # Number of modes used

# The simulation timestep
dz = (zmax-zmin)/Nz  # resolution along z
dt = dz/c   # Timestep (seconds)
N_step = int(1000e-6 / dz)          # Number of iterations to perform (tot length/resolution)
...
n_e = 0.294e18*1.e6 # Density (electrons.meters^-3)
p_nz = 2         # Number of particles per cell along z
p_nr = 2         # Number of particles per cell along r
p_nt = 4         # Number of particles per cell along theta

# The laser
a0 = 2.346          # Laser amplitude
w0 = 30.e-6       # Laser waist
ctau = 12.e-6     # Laser duration
z0 = -40.e-6      # Laser centroid
