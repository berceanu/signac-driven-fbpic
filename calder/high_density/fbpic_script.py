...
Usage
-----
- Type "python calder_high_density.py" in a terminal
...
N_step = int(1200e-6 / dz)          # Number of iterations to perform (tot length/resolution)
...
n_e = 1.2e19*1.e6 # Density (electrons.meters^-3)
