...
parameters in doi:10.1016/j.jcp.2008.11.017. Self-injection
is NOT observed for these parameters.

Usage
-----
- Type "python calder_no_injection.py" in a terminal
...
N_step = int(2500e-6 / dz)          # Number of iterations to perform  (tot length/resolution)
...
# The laser
a0 = 1.3          # Laser amplitude
w0 = 18.e-6       # Laser waist
