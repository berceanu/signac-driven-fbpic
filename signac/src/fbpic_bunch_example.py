...
# The bunch
bunch_zmin = z0 - 15.0e-6
bunch_zmax = bunch_zmin + 3.0e-6
bunch_rmax = 10.0e-6
bunch_gamma = 400.0
bunch_n = 5.0e23
...
if __name__ == "__main__":
    ...
    bunch = add_particle_bunch(
        sim, -e, m_e, bunch_gamma, bunch_n, bunch_zmin, bunch_zmax, 0, bunch_rmax
    )
    if track_bunch:
    ...
    sim.diags = [
        ...
        FieldDiagnostic(
            dt_period=dt_boosted_diag_period, fldobject=sim.fld, comm=sim.comm
        ),
        ParticleDiagnostic(
